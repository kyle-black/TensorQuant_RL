...
class ForexEnv(gym.Env):
    def __init__(self, data, max_steps=2500):
        ...
        #self.early_stop_threshold = -100  # Adjusted for scaled rewards
...
class ForexEnv(gym.Env):
    ...
    def step(self, action):
        ...
        # Calculate past standard deviation for barriers
        ...
        # Update reward history for early stopping
...
# Rest of the ForexTradingModel class and __main__ section remain the same
